...
public class VectorDemo {
    public static void main(String[] args) {
        ...
        Vector vector6 = Vector.add(vector3, vector5);
        Vector vector7 = Vector.add(vector5, vector5);
        Vector vector8 = new Vector(array4);
        vector8.multiplyByScalar(2);
        Vector vector9 = new Vector(array4);
        vector9.revert();
        Vector vector10 = Vector.subtract(vector5, vector3);
        ...
        System.out.println("vector6 = Vector.add(vector3, vector5) = " + vector6.toString());
        System.out.println("vector7 = Vector.add(vector5, vector5)" + vector7.toString());
        System.out.println("vector8 = " + vector8.toString());
        System.out.println("vector9 = " + vector9.toString());
        System.out.println("vector10 = Vector.subtract(vector5, vector3) = " + vector10.toString());
        ...
        System.out.println("scalar product of vector2 and vector5 = " + Vector.getScalarProduct(vector2, vector5));

        Vector vector15 = new Vector(3);
        vector15.setElement(1, 3);
        System.out.println("3.0 set as element of vector15 by index 1 = " + vector15);
        System.out.println("size of vector15  = " + vector15.getSize());
    }
}